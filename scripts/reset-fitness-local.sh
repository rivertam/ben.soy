...
# `exercise_aliases` and `fitness_muscle_targets` are configuration, not
# imported archive data: preserve both across resets.
...
' DELETE running_activities RETURN NONE; DELETE daily_steps RETURN NONE;'\
